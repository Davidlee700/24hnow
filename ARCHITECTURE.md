...
| API | 무료 한도 | 주 1회 사용량 | 여유 |
|-----|----------|-------------|------|
| Kakao REST | 300,000 calls/일 | ~600 calls | 99.8% |
| Naver 검색 | 25,000 calls/일 | ~1,000 calls | 96% |
| Naver Geocoding | 200,000 calls/월 | ~3,000 calls | 98.5% |

수집 수량:
- Kakao: 66개 지역 × 3개 카테고리 × 최대 45건 = **최대 8,910건**
- Naver: 66개 지역 × 3개 카테고리 × 최대 25건 = **최대 4,950건**
- dedup 후 예상 순수 매장 수: **약 2,000~4,000건**

### 서비스 (사용자 접속)

| 항목 | 무료 한도 | 비고 |
|------|----------|------|
| Kakao Maps SDK | 300,000 pageloads/일 | 마커는 DOM, 추가 과금 없음 |
| Supabase 대역폭 | 5GB/월 | ~1만 MAU까지 무료 |
...
| 날짜 | 스프린트 | 주요 변경 |
|------|---------|---------|
| 2026-04-27 | 초기 세팅 | 지도, 마커, Supabase, 카카오 SDK |
| 2026-04-27 | UI 개선 | SEO, 디테일창, 길찾기 버그, 카테고리 마커 |
| 2026-04-27 | 데이터/구조 | 서울/경기/인천 확대, 페이지네이션, 소스 정리 |
